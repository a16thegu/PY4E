...
#         Sample data: http://py4e-data.dr-chuck.net/regex_sum_42.txt (There are
#         90 values with a sum=445833)

#         Actual data: http://py4e-data.dr-chuck.net/regex_sum_301415.txt (There
#         are 84 values and the sum ends with 886)
...
# Reference: https://www.py4e.com/html3/11-regex
